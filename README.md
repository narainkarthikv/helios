...
GLIS is an open-source project aimed at providing a comprehensive solution for managing and visualizing geospatial data. This documentation will guide you through the process of contributing to this project.
...
<table>
    <tr>
     <td>Frontend</td>
     <td><img src="https://skillicons.dev/icons?i=react,vite,tailwindcss" /></td>
    </tr>
    <tr>
     <td>Backend</td>
...
We welcome contributions! To contribute to GLIS, follow these steps:
